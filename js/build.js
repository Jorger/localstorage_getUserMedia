...
var Persona = function () {
    ...
    _createClass(Persona, [{
        ...
        value: function getPersona() {
            return [this.guid, "<img src = '" + this.foto + "' class = 'ftabla'>", this.identificacion, this.primernombre + " " + this.primerapellido, this.email, this.fechanacimiento, this.calculaEdad()];
        }
    }]);
...
var config = { nombre: "userPhoto1", tipo: "localStorage" };
